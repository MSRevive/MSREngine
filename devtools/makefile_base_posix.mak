...
ifeq ($(CFG), release)
	OptimizerLevel_CompilerSpecific = -U_FORTIFY_SOURCE -g0 -O3
else
...
LDFLAGS = $(CFLAGS) $(GCC_ExtraLinkerFlags) -Wl,-gc-sections $(OptimizerLevel)
...
WARN_FLAGS += -Wno-delete-non-virtual-dtor -Wno-sign-compare -Wno-strict-aliasing -Wno-ignored-attributes
